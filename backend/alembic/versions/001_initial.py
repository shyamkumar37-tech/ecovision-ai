...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('type',       sa.Enum('university','college','institute', name='institution_type'), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column('role',            sa.Enum('student','faculty','sustainability_officer','admin', name='user_role'), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column('status',      sa.Enum('processing','ready','failed', name='document_status'), default='processing'),
    ...
    op.create_table(
        ...
        sa.Column('type',       sa.Enum('alert','report_ready','doc_indexed','tip','system', name='notification_type'), nullable=False),
